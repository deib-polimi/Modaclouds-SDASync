...
public class Config {
	...
	private Config() throws ConfigurationException {
		try {
			String sdaIP = getMandatoryEnvVar(Env.MODACLOUDS_MATLAB_SDA_IP);
			String sdaPort = getMandatoryEnvVar(Env.MODACLOUDS_MATLAB_SDA_PORT);
			sdaURL = "http://"+sdaIP+":"+sdaPort+"/data";
	...
	public String getSdaURL() {
		return sdaURL;
	}

	public void setSdaURL(String sdaURL) {
		this.sdaURL = sdaURL;
	}
